...
function renderIdagVinduer() {
  ...
  html += '<h3 class="idag__vinduer-t2" style="margin-top:-10px">Rejse i tid \u2014 alene eller med nogen</h3>';
  ...
  html += '<h3 class="idag__vinduer-t2" style="margin-top:-4px">Se med nogen</h3>';
